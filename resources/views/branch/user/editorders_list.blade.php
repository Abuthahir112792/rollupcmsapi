   ...
   <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="modal-body">
                    <form action="{{ route('branch.allOrderdetailsUpdate') }}" method="post" id="all_add_order_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                          <div class="row form-group d-flex">
                          ...
                          <div class="modal-footer">
                            <a href="{{route('branch.orders')}}"><button type="button" class="btn btn-info" data-dismiss="modal">Cancel</button></a>
...
@section('page_js')
<script type="text/javascript" src="{{asset('branch/custom_js/editorder_list.js')}}"></script>
<script>
