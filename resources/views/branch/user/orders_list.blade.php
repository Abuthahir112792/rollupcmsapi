        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('branch.incomingOrderUpdate') }}" method="post" id="incoming_order_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
    ...
    <div id="out-for-delivery-order" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('branch.outforOrderUpdate') }}" method="post" id="out_for_delivery_order_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Order Description :</label>
                            <div class="col-md-8">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-footer border-0 p-0">
                    <a href="{{route('branch.orders')}}"  class="btn btn-link text-dark text-decoration-none">OK</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="swift_order_modal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('branch.swiftOrderUpdate') }}" method="post" id="out_for_delivery_order_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
...
@section('page_js')
<script type="text/javascript" src="{{asset('branch/custom_js/order_list.js')}}"></script>
<script>
