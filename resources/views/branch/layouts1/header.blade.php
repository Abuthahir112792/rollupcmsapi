<nav class="navbar navbar-default navbar-fixed-top">
	<div class="brand" style="padding:0px 39px;">
		<a href="{{route('branch.home')}}"><img src="{{ \App\Helpers\Helper::getLogo('header') }}" alt="YouGo" class="img-responsive logo" style="height: 78px;width: 115px;"></a>
	</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="{{ route('branch.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
					</ul>
				</li>
			</ul>
