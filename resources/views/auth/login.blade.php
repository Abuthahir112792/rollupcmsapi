...
<head>
    ...
    <!-- ICONS -->
    <link rel="apple-touch-icon" sizes="96x96" href="{{asset('theme/assets/img/logo_two.png')}}">
        ...
        <div class="vertical-align-middle">
            <div class="auth-box ">
                <div class="left">
                    <div class="content">
                        <div class="header">
                            <div class="logo text-center"><img src="{{ \App\Helpers\Helper::getLogo('login') }}" alt="YouGo Logo" height="155" width="155"></div>
