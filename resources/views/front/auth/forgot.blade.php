...
@section('title')
    {{ trans('front/label.title') }} - {{ trans('front/label.forgot.title') }}
@stop
@section('css')
                ...
                <div class="contact-agileinfo">
                    <div class="contact-form wthree">
                        <form>
                            ...
                            <input class="btn-primary" type="button" id="btn_forgot" value="{{ trans('front/label.forgot.go') }}" style="display: none">
                            </div>
                        </form>
                    </div>
                </div>
...
@section('footer')
    <footer style="text-align: center;" >
        <div class="container">
            <span 
            style="color:black"
            class="other-links">{{ trans('front/label.forgot.are_you_a_newbie') }} <a style="color: #416230;text-decoration: none !important;" href="{{ route('front.register') }}">{{ trans('front/label.forgot.sign_up') }}</a></span>
        </div>
    </footer>
@stop
