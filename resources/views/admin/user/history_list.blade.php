                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <div class="row">
                                 <div class="col-md-9">
                                        <a href="{{ route('admin.export_excel.excel') }}" class="btn btn-primary">Excel</a>
                                </div>
                                <div class="col-md-3">
                            ...
                            <tbody>
                                @include('admin.user.historypagination_list')
                            </tbody>
                            </table>
...
@section('page_js')
<script type="text/javascript" src="{{asset('custom_js/history_list.js')}}"></script>
<script>
