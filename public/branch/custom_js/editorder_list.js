...
//alert(ididid);
    ...
    var all_orderlist_table = getAjaxData('branch/all-orders-list/'+editorderid, {});
    ...
    function get_orderlist_list(editorderid) {
        $.ajax({
                type        : 'GET',
                url         : APP_URL + '/branch/get_userorderlist_list/details/'+editorderid,
                cache : false,
                processData: false
            })
...
$('.loder_cla').addClass('div_hide');
        ...
        $(document).on('keyup','.qty',function(e){
           $('.alert-status').html('');
            ...
            $.ajax({
            type        : 'GET',
            url         : APP_URL + '/branch/updateallorderdetails/'+editorderid+'/'+itemid+'/'+qty,
            cache : false,
            processData: false
        })
        .done(function(response) {
