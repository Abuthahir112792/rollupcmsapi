...
jQuery(document).ready( function() {
    ...
    var incoming_order_table = getAjaxData('admin/incoming-orders', {});
    ...
    var out_for_delivery_tbl = getAjaxData('admin/out-for-delivery', {});
    ...
    var self_pickup_tbl = getAjaxData('admin/self-pickup', {});
    ...
    /*$(document).on('click','.edit_order1',function(e){
        ...
        $.ajax({
                type        : 'GET',
                url         : APP_URL + '/admin/order/details/'+id,
                cache : false,
                processData: false
            })
    ...
    $(document).on('click','.edit_order1',function(e){
        ...
        var id = $(this).data('id');
        window.location.href = APP_URL+'/admin/editorder/'+id;
    });
        ...
        $.ajax({
                type        : 'GET',
                url         : APP_URL + '/admin/orderitem/details/'+id,
                cache : false,
                processData: false
            })
            .done(function(response) {
...
$(document).on('change','.ordersids',function(e){
        ...
        $.ajax({
            type        : 'GET',
            url         : APP_URL + '/admin/orderstatus/'+id+'/'+Status,
            cache : false,
            processData: false
        })
        .done(function(response) {
...
$(document).on('click','.swift_order',function(e){
        ...
        $.ajax({
                type        : 'GET',
                url         : APP_URL + '/admin/branch/details/'+order_id,
                cache : false,
                processData: false
            })
         .done(function(response) {
